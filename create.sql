...
CREATE TABLE Productor(
    ...
    fk_p        INT             REFERENCES  Productor(p_id),
    fk_p_asoc   INT,
    fk_p_ciu    INT             NOT NULL,
    FOREIGN KEY (fk_p_asoc)     REFERENCES  Asociacion(asoc_id),
...
CREATE TABLE Apadrinamiento(
    ...
    ap_fechafin DATE,
    ap_aporte   MONEY,
    fk_ap_pad   INT             NOT NULL,
    fk_ap_p     INT             NOT NULL,
    fk_ap_v     INT             NOT NULL,
...
CREATE TABLE P_Prov(
    fk_pp_p         INT             NOT NULL,
    fk_pp_prov      INT             NOT NULL,
...
CREATE TABLE Convenio(
    ...
    FOREIGN KEY     (fk_conv_pp1, fk_conv_pp2)    
        REFERENCES  P_Prov(fk_pp_p, fk_pp_prov),
    CONSTRAINT      chk_convenio    CHECK 
    (
        CASE WHEN fk_conv_asoc IS NULL THEN fk_conv_pp1 IS NOT NULL AND fk_conv_pp2 IS NOT NULL
        ELSE fk_conv_pp1 IS NULL AND fk_conv_pp2 IS NULL END
    )
);
...
CREATE TABLE Contrato(
    ...
    fk_cont_cli         INT             NOT NULL,
    fk_cont_p           INT             NOT NULL,
...
CREATE TABLE Renovacion(
    ...
    fk_ren_cont1    INT    NOT NULL,
    fk_ren_cont2    INT    NOT NULL,
    fk_ren_cont3    INT    NOT NULL,
...
CREATE TABLE Pago(
    ...
    fk_pag_cont1    INT    NOT NULL,
    fk_pag_cont2    INT    NOT NULL,
    fk_pag_cont3    INT    NOT NULL,
    PRIMARY KEY     (pag_id, fk_pag_cont1, fk_pag_cont2, fk_pag_cont3),
...
CREATE TABLE Formula(
    ...
    fk_for_cli      INT             NOT NULL,
    fk_for_var      INT             NOT NULL,
...
CREATE TABLE Detalle_V(
    ...
    dv_decuento     SMALLINT,
    fk_dv_cont1     INT             NOT NULL,
    fk_dv_cont2     INT             NOT NULL,
    fk_dv_cont3     INT             NOT NULL,
    fk_dv_cult      INT             NOT NULL,
...
CREATE TABLE Envio(
    ...
    fk_env_v        INT             NOT NULL,
    fk_env_dv1      INT             NOT NULL,
    fk_env_dv2      INT             NOT NULL,
    fk_env_dv3      INT             NOT NULL,
    fk_env_dv4      INT             NOT NULL,
...
CREATE TABLE Precio_Promedio(
    ...
    fk_pro_v        INT             NOT NULL,
    fk_pro_pais     INT             NOT NULL,
...
CREATE TABLE Ingrediente_Receta(
    ...
    fk_ir_rec       INT                 NOT NULL,
    fk_ir_ing       INT                 NOT NULL,
    ...
    (
        ir_unidad IN ('gr','kg','lt', 'ml')
    )
);
CREATE TABLE V_Receta(
    cantgr          INT             NOT NULL,
    fk_vr_rec       INT             NOT NULL,
    fk_vr_v         INT             NOT NULL,
