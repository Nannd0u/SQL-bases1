...
CREATE TABLE Productor(
    ...
    fk_p        VARCHAR(255)    REFERENCES  Productor(p_id),
...
CREATE TABLE Produccion(
    ...
    fk_prod_cult    VARCHAR(256)    NOT NULL,
...
CREATE TABLE Convenio(
    ...
    fk_conv_pp1     VARCHAR(255),
    fk_conv_pp2     VARCHAR(255),
